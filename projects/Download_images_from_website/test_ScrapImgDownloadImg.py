...
class Test_ScrapImgDownloadImg:
    ...
    def test_successful_image_download(self):
        ...
        if not os.path.isdir(output_dir):
            os.mkdir(output_dir)
        module.download_img(url, index)
        assert os.path.isfile(os.path.join(output_dir, f'{index+1}.jpg'))
        assert filecmp.cmp(os.path.join(output_dir, f'{index+1}.jpg'), requests.get(url).content)
    ...
    def test_non_image_url(self):
        ...
        index = 0
        module.download_img(url, index)
        assert not os.path.isfile(os.path.join('output', f'{index+1}.jpg'))
    ...
    def test_unsupported_image_type(self):
        ...
        index = 0
        module.download_img(url, index)
        assert not os.path.isfile(os.path.join('output', f'{index+1}.bmp'))
